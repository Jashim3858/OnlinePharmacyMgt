<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyRoleMgt.aspx.cs" Inherits="OnlinePharmacyManagement.Pages.MyRoleMgt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>User's and Role's Management</h1>
    <div class="row">
        <div class="col-sm-12 table-responsive">
            <h2>User's</h2>
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id" AutoGenerateColumns="false" SelectMethod="grdUsers_GetData" ItemType="OnlinePharmacyManagement.Models.ApplicationUser" CssClass="table table-hover table-bordered table-striped table-condensed" OnPreRender="grdUsers_PreRender">
                <Columns>
        ...
        <div class="col-sm-6">
            <asp:DetailsView ID="dvUsers" runat="server" DataKeyNames="Id" AutoGenerateRows="false" CssClass="table table-bordered table-condensed table-hover table-responsive" SelectMethod="dvUsers_GetItem" UpdateMethod="dvUsers_UpdateItem" InsertMethod="dvUsers_InsertItem" DeleteMethod="dvUsers_DeleteItem">
                <Fields>
                    <asp:BoundField HeaderText="Email" DataField="Email" />
